...
- (void)setUpRepostViewFrame
{
    ...
    CGFloat text_Y = CGRectGetMaxY(_repostIconFrame) + MRTStatusCellMargin;
    ...
    CGRect text_Rect = [self.repost.text boundingRectWithSize:CGSizeMake(text_Width, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin attributes:textAttrs context:nil];
    
    _repostTextFrame = CGRectMake(text_X, text_Y, ceil(text_Rect.size.width), ceil(text_Rect.size.height));
