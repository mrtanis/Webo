...
{
    if ([_delegate respondsToSelector:@selector(playVideoOnView:indexPath:fromOriginal:)]) {
        [_delegate playVideoOnView:superView indexPath:_indexPath fromOriginal:fromOriginal];
    }
}
