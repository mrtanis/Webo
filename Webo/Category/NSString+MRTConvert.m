...
+ (NSMutableDictionary *)videoUrlFromString:(NSString *)htmlStr
{
    ...
    if (range2begin.location != NSNotFound) {
        ...
        NSString *substr = [htmlStr substringWithRange:NSMakeRange(range2begin.location + range2begin.length, range2end.location - range2begin.location - range2begin.length - 1)];
